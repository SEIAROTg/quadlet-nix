...
let
  ...
  self = {
    ...
    mkObjectOptions = objectType: extraOptions: lib.attrsets.unionOfDisjoint (mkCommonOptions objectType) extraOptions;

    mkTopLevelOptions = extraOptions: let
